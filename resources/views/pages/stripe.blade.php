                    ...
                    <div class="panel panel-default credit-card-box">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="/stripe" method="post" class="require-validation"
                                data-cc-on-file="false" data-stripe-publishable-key="{{ config('stripe.stripekey') }}"
                                id="payment-form">
                                @csrf
                                ...
                                <div class="form-row row form-change">
                                    ...
                                    <div class="col-xs-12">
                                        <button class="btn btn-primary btn-lg btn-block btn-pay" type="submit">Pay
                                            Now</button>
                                    </div>
                                </div>
                            </form>
