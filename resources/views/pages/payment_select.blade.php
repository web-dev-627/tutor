                        ...
                        <div class="l-col l-col--main">
                            <div class="box checkout">
                                ...
                                <div class="box__content">
                                    <Form class="form" id = "payment_select" action="/payment_select1" method="get">
                                        {{-- {{ csrf_field() }} --}}
                                        <div class="box__group js-checkout-tabs-wrap">
                                            ...
                                            <div class="js-bill-buttons form-group">
                                                ...
                                                <div class="tab-content tab-content--no-animation js-switcher-content active" data-name="braintree">
                                                    ...
                                                    <button type="submit" class="btn btn--success btn--l js-submit-braintree js-ga-send" id="continue_btn" data-pay="Pay" data-ga-action="Checkout" data-ga-label="submitApplePayButtonCheckout" data-qa-id="submit-braintree-checkout-btn">
                                        ...
                                        <div class="sc-cSHVUG jtmyZG">
                                            <div class="sc-VigVT FMGNq">
                                                <div class="sc-fjdhpX cNjroL">
                                                    ...
                                                    <div class="MuiAvatar-root Avatar_avatar__20Ocl Avatar_m__1jv1v"><img src="" class="MuiAvatar-img"></div>
                                                ...
                                                <div class="sc-gqjmRU MnifU">
                                                    <div class="sc-iwsKbI exZsDe"><span class="sc-EHOje llWuUc" data-nsfw-filter-status="swf"><p class="tutor_name" style="margin-bottom: 0px;"> </p></span><img alt=""   class="sc-dnqmqq hHaWTk"><svg width="13" height="15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="sc-chPdSV gVINSj">
                                                ...
                                                <div class="sc-kAzzGY eLeeeF">
                                                    ...
                                                    <div class="sc-jKJlTe eKUzsH">$<p class="tutor_tuition" style="margin-bottom: 0px;"></p></div>
                                                </div>
                                                <div class="sc-kAzzGY eLeeeF">
                                            ...
                                            <div class="sc-hMqMXs bYrtVz">
                                                <div class="sc-kAzzGY eLeeeF" style = "display: flex;
                                                flex-direction: row;
                                                align-content: center;
                                                justify-content: space-between;
                                                align-items: center;">Total  <span class = "total"> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    var image_path = url.split("/")[6];

    var total_price = Number(price) + 0.25;

    // String total_price_str = Integer.toString(total_price);
    // console.log(total_price_str);

    
    $(".tutor_name").html(name);
    $(".tutor_tuition").html(price);
    $(".total").html(("$"+(price)+".25"));

    $('.MuiAvatar-img').attr('src', "http://blablatutors.com/public/images/"+image_path);


    $("#continue_btn").on("click", function(e) {
        e.preventDefault();
        $("#payment_select").attr ('action',"http://blablatutors.com/payment_select1/"+(price+".25")+"/"+name).submit();
    });

    //$('.form').attr('action',"/payment_select1/"+price/name);
