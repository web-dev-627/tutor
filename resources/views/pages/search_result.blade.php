<ul class="profile">
    @foreach ($t_data as $Tutors)
        <li class="tutor row tutor1 tutor_success">
            <div class="photo col-md-2 col-sm-8 col-xs-8">
                ...
                <div class="gallery">   
                    <a target="_blank" href="#">
                        <img src="public/images/{{ $Tutors->image_title }}"  alt="Cinque Terre" width="600" height="400">
                    </a>
            ...
            <div class="content col-md-2">
                ...
                <div class="btns  row">
                    <div class="btn_1 col-md-12 "> <button type="button" class="btn btn-primary btn-2">Timetable</button>
                    </div>
                    {{-- <div class="btn_1 col-md-12 "> <a href="/zoom" class="btn btn-primary btn-2">Link
                            Zoom</a> </div> --}}
                    <div class="btn_1 col-md-12 "> <a href="/payment_select" class="btn btn-info btn-2">Make a Payment
                            </a> </div>
    ...
    @endforeach
    <input type="hidden" id="page_count" value="{!!$t_data->lastPage()!!}">
</ul>
