    ...
    <div class="main1">
        <div class="complex-search row">
            <div class="col-md-4 col-xs-4">
                ...
                <select class="form-control select2 select2-hidden-accessible tutor_major" name="tutor_major"
            ...
            <div class="col-md-4 col-xs-4">
                ...
                <select class="form-control select2 select2-hidden-accessible tutor_country" name="tutor_country"
                    style="width: 100%;" tabindex="-1" aria-hidden="true">
            ...
            <div class="col-md-4 col-xs-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible tutor_language" name="tutor_language"
                        style="width: 100%;" tabindex="-1" aria-hidden="true">
                        <option class="place-holder" value="" selected="selected"> Select language... </option>
                        @foreach ($languages as $language)
                            <option class="place-holder" style="margin:auto;" value="{!! $language->language !!}">
        ...
        <div class="row">
            <div class="col-md-4 col-xs-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible tutor_also" name="tutor_also"
                        style="width: 100%;" tabindex="-1" aria-hidden="true">
            ...
            <ul class="profile">
                @foreach ($t_data as $Tutors)
                    <li class="tutor row tutor1 tutor_success">
                        <div class="photo col-md-2 col-sm-8 col-xs-8">
                            ...
                            <div class="gallery">
                                <a target="_blank" href="#">
                                    <img src="public/images/{{ $Tutors->image_title }}" alt="Cinque Terre" width="600"
                                        height="400">
                                </a>
                        ...
                        <div class="description col-md-5 col-sm-8">
                            <div class="first-line">
                                <h4 class="Name"> {{ $Tutors->name }}</h4>
                                <img alt="Russia" class="CountryFlagImg___83cde CountryFlagImgEnabled___39BAf"
                                    src="https://static.preply.com/images/new/flags-svg/4x3/ru.svg" width="16px"
                                    height="12px">
                                <svg class="VerifiedTutorIcon___1Sswo" width="16" height="19" viewBox="0 0 16 19"
                                ...
                                <ul class="lang_sel">
                                    ...
                                    <li class="SpeaksItem___28ZUB">{{ $Tutors->native_language }}:Native &nbsp &nbsp
                                        {{ $Tutors->also }} (also)<span
                                            class="SpeaksLevel___2Fg_I SpeaksLevelGreen___3JBst"></span>
                                    </li>
                            ...
                            <div class="forth-line">
                                <div>
                                    ...
                                    <a class="SeoSnippetViewProfileCTA___2DxQQ" target="_blank"
                                        data-clickable-element="true">View full profile<svg class="NewTabArrow___3JMhK"
                                            width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="#">
                        ...
                        <div class="content col-md-2">
                            <div class="CoreIndicatorsWrap____8r4Z">
                                <div class="CoreIndicatorsItem___1niNK">
                                    <div class="RatingIndicator___1x9Q_">
                                        <div class="RatingIndicatorRating___374zP"><svg height="23" viewBox="0 0 24 23"
                                                width="24" xmlns="http://www.w3.org/2000/svg"
                                                class="RatingStarIcon___1RRIx">
                                                <path
                            ...
                            <div class="btns row">
                                <div class="btn_1 col-md-12 "> <a href="" class="btn btn-info btn-2">Timetable</a>
                                </div>
                                {{-- <div class="btn_1 col-md-12 "> <a href="/zoom" class="btn btn-primary btn-2">Link Zoom</a>
                                </div> --}}
                                <div class="btn_1 col-md-12 "> <a href="/payment_select/{{ $Tutors->tuition }}/{{ $Tutors->name}}/{{ $Tutors->image_title }}" name="{{ $Tutors->tuition }}" id="{{ $Tutors->name }}" class="btn btn-success btn-2">Make
                                        a Payment</a> </div>

                            </div>
                        </div>
                        <div class="col-md-3">
                            <video class="video" max-width="295" max-height="240" controls>
                                <source src="public/videos/{{ $Tutors->v_title }}" alt="Cinque Terre" type="video/mp4">
                            </video>
                        </div>
                    </li>
                @endforeach
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                $('#tutor_results').on('click', 'a.page-link', function() {
                    ...
                    var page_compare = $('#page_count').val();
                    //var page_compare = $('.page-item').siblings().length-2;
                    if ($(this).attr('rel') == "prev") {
                        page = Number($('ul.pagination li.active span').text());
                        var major = $('.tutor_major').val();
                        var name = $('.tutor_name').val();
                        var country = $('.tutor_country').val();
                        var native_lang = $('.tutor_lang').val();
