...
<html lang="zxx">  
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Edula - Online Education HTML5 Template</title>
        ...
        <!-- style css -->
        <link rel="stylesheet" type="text/css" href="css/style1.css"> <!-- This stylesheet dynamically changed from style.less -->
        <!-- responsive css -->
    ...
    <body class="defult-home">
                            ...
                            <div class="col-md-7">
                                <ul class="topbar-contact">
                                    <li>
                                        ...
                                        <a href="tel:+(111)256 352">Call: +(111)256 352</a>
                                    </li>
                                    <li>
        ...
        <div class="main-content">
            ...
            <!-- About Section Start -->
            <div id="sc-about" class="sc-about pt-80 pb-170 md-pt-40 md-pb-70 position-relative arrow-animation-1">
                <div class="container">
                    <div class="row align-items-center">
            ...
            <div class="sc-counter style2-about pt-120 pb-115 md-pt-80 md-pb-50 counter-bg1 position-relative arrow-animation-1">
                <div class="container">
            ...
            <!-- Team Section Start -->
            <div class="sc-team team-style-1 pt-110 pb-90 md-pt-70 md-pb-50">
                <div class="container">
            ...
            <div class="sc-testimonial style1 pt-115 pb-120 md-pt-75 md-pb-80">
                <div class="container">
                    <div class="sec-title mb-30 text-center md-mb-10">
                        ...
                        <h2 class="title mb-0">Always Stufents happy with Us</h2>
                    </div>
